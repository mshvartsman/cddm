...
/**
 * @brief Throw informative errors
 * @details Can do things like throw fatal_error() << "SOMETHING BAD". 
 * Taken verbatim from http://marknelson.us/2007/11/13/no-exceptions/. 
 */
